...
python -m src.data_fetcher --year 2024 --gp Monaco
    ...
    if is_sprint_weekend:
        tab_names = ["📊 Overview", "🔧 Practice", "⏱️ Qualifying", "🏃 Sprint", "🏁 Race", "🔮 Predict"]
    else:
        tab_names = ["📊 Overview", "🔧 Practice", "⏱️ Qualifying", "🏁 Race", "🔮 Predict"]
    ...
    # ═══════════════════════════════════════════════════════════════════════
    with tabs[2]:
        st.markdown("### ⏱️ Qualifying Results")
    ...
    if is_sprint_weekend:
        with tabs[3]:  # Sprint tab
            ...
            sprint_sub_tabs = st.tabs(["⏱️ Sprint Qualifying", "🏁 Sprint Race"])
            
            # ─────────────────────────────────────────────────────────────────
            # SPRINT QUALIFYING / SHOOTOUT
            # ─────────────────────────────────────────────────────────────────
            with sprint_sub_tabs[0]:
                st.markdown("### ⏱️ Sprint Qualifying")
                    ...
                    if has_quali_times:
                        ...
                        <div style="background: rgba(100,196,255,0.1); border: 1px solid rgba(100,196,255,0.3); 
                            ...
                            <div style="font-family: 'Inter', sans-serif; color: rgba(255,255,255,0.6); font-size: 0.85rem; margin-top: 0.5rem;">
                                ...
                                <br>
                                Check the <strong>⏱️ Qualifying</strong> tab for the Sprint grid positions.
                            </div>
                        </div>
                        """, unsafe_allow_html=True)
                    ...
                    if gp_year and gp_year <= 2022:
                        ...
                        <div style="background: rgba(100,196,255,0.1); border: 1px solid rgba(100,196,255,0.3); 
                            ...
                            <div style="font-family: 'Inter', sans-serif; color: rgba(255,255,255,0.6); font-size: 0.85rem; margin-top: 0.5rem;">
                                ...
                                determined the Sprint grid. Check the <strong>⏱️ Qualifying</strong> tab.
                            </div>
                        </div>
                        """, unsafe_allow_html=True)
                    else:
